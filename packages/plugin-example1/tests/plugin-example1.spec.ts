...
import pluginExample1Plugin from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/plugin-example1 checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    pluginExample1Plugin(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(pluginExample1Plugin).to.be.a("function");
    });
  });
